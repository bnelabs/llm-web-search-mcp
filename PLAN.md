...
Create `/home/komedihp/searxng/k8s/settings.yml` (SearXNG config):
- Enable JSON output format (`formats: [html, json]`)
- `limiter: false` (localhost only, no need)
- `public_instance: false`
- Engines: Google, DuckDuckGo, Brave, Wikipedia, StackOverflow, GitHub, Arxiv
...
### Phase 6: Register with MCP Clients
